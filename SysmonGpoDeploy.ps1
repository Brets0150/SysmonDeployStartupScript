...
# The URL Sysmon is downloaded from, versions is checked against, and the SwiftOnSecurity Sysmon configuration file is downloaded from. -- DO NOT CHANGE
...
[string]$global:SwiftOnSecuritySysmonConfigUrl = "https://raw.githubusercontent.com/SwiftOnSecurity/sysmon-config/master/sysmonconfig-export.xml"
...
Function Get-SwiftOnSecuritySysmonConfig {
	...
	try {
		$SwiftOnSecuritySysmonConfig = Invoke-WebRequest -Uri $global:SwiftOnSecuritySysmonConfigUrl -UseBasicParsing
